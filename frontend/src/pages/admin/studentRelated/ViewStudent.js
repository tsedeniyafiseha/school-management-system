...
const ViewStudent = () => {
    ...
    useEffect(() => {
        if (userDetails && userDetails.sclassName && userDetails.sclassName.id !== undefined) {
            dispatch(getSubjectList(userDetails.sclassName.id, "ClassSubjects"));
        }
    ...
    const StudentMarksSection = () => {
        ...
        const renderChartSection = () => {
            return (
                <>
                    <CustomBarChart chartData={subjectMarks} dataKey="marks_obtained" />
                </>
            )
        }
        return (
