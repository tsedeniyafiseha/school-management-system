...
const AddTeacher = () => {
  ...
  const teachSubject = subjectDetails && subjectDetails.id
  const teachSclass = subjectDetails && subjectDetails.sclassName && subjectDetails.sclassName.id
    ...
    <div>
      <div className="register">
        <form className="registerForm" onSubmit={submitHandler}>
          ...
          <br />
          <label>
            Subject : {subjectDetails && subjectDetails.sub_name}
          </label>
          <label>
            Class : {subjectDetails && subjectDetails.sclassName && subjectDetails.sclassName.class_name}
          </label>
          <label>Name</label>
