...
const ShowTeachers = () => {
    ...
    useEffect(() => {
        dispatch(getAllTeachers(currentUser.id));
    ...
    const rows = teachersList.map((teacher) => {
        return {
            name: teacher.name,
            teachSubject: teacher.teachSubject?.sub_name || null,
            teachSclass: teacher.teachSclass.class_name,
    ...
    const actions = [
        ...
        },
        {
            ...
            action: () => deleteHandler(currentUser.id, "Teachers")
        },
    ];
